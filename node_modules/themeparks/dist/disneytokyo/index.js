    ...
    _createClass(DisneyTokyoPark, [{
        ...
        value: function FetchWaitTimes() {
            ...
            return new Promise(function (resolve) {
                // get ride names
                _this2.GetRideNames().then(function (rideData) {
                    // fetch wait times HTML page
                    _this2.FetchWaitTimesURL().then(function (HTML) {
                        // parse HTML data
                        _this2.ParseWaitTimesHTML(HTML).then(function (rideTimes) {
        ...
        value: function FetchWaitTimesURL() {
            ...
            return this.GetAcccessToken().then(function (access_token) {
                return _this3.HTTP({
                    url: "http://info.tokyodisneyresort.jp/rt/s/realtime/" + _this3[s_parkID] + "_attraction.html",
                    headers: {
        ...
        key: "ParseWaitTimesHTML",
        value: function ParseWaitTimesHTML(HTML) {
